...
C={
 1:{
  'name':'算例一（无遮挡冲突）',
  'bigarm':(9380,10360),'smallarm':(35550,35700),'phase2':(35700,39230),
  'wait':(39230,53560),'phase3':(53560,55400),'idle':None,
  'phase4':(55400,56170),'phase5':(56170,56630),'idle56':(56630,59430),'phase6':(59430,60990),
  'horizon':66000,'ba_adv':'12.0','sa_adv':'5.5','occ_delay':0,
 },
 2:{
  'name':'算例二（遮挡冲突）',
  'bigarm':(15250,16230),'smallarm':(47640,47790),'phase2':(47790,51320),
  'wait':(51320,59430),'phase3':(59430,61270),'idle':(61270,65360),
  'phase4':(65360,66130),'phase5':(66130,66590),'idle56':None,'phase6':(66590,68150),
  'horizon':74000,'ba_adv':'12.0','sa_adv':'4.9','occ_delay':4090,
 },
}
